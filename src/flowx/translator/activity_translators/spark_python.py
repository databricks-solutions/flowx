...
from flowx.models.ir import Activity, SparkPythonActivity, TranslationContext
...
def translate(
    ...
    parameters = [_resolve_parameter(parameter, context) for parameter in raw_parameters]
