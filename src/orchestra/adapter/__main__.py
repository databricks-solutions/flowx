"""CLI bridge that lets the flowx skills drive the adapter via subprocesses.

The skills (`/flowx:translate`, `/flowx:migrate`) cannot keep a
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    inputs = subparsers.add_parser(
        "inputs",
        help="Emit the migration-phase input questions for an flowx phase as JSON.",
    )
    inputs.add_argument(
        "phase",
