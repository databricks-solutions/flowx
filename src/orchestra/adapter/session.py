...
class TranslationSession:
    ...
    def _collect_motif_consolidations(self) -> dict[str, MotifConsolidate]:
        ...
        """
        from flowx.adapter.constants import MOTIF_CONSOLIDATE_QUESTION_PREFIX
...
_INGEST_QUESTIONS: tuple[MigrationInputQuestion, ...] = (
    ...
    MigrationInputQuestion(
        ...
        prompt="Where should flowx write the ingest output?",
...
_TRANSLATE_QUESTIONS: tuple[MigrationInputQuestion, ...] = (
    ...
    MigrationInputQuestion(
        question_id=INPUT_OUTPUT_DIR,
        prompt="Where should flowx write the translate output?",
...
_PREPARE_QUESTIONS: tuple[MigrationInputQuestion, ...] = (
    MigrationInputQuestion(
        ...
        description=(
            "Preference-stamped report from `python -m flowx.adapter modify`, "
